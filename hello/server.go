...
func main() {
    ...
    //["Jack" "Alex" "Sara"]
    //[SARA ALEX JACK]
    //map[age:37 children:["Sara","Alex","Jack"] fav.movie:Deer Hunter friends:[{"first":"Dale","last":"Murphy","age":44},{"first":"Roger","last":"Craig","age":68},{"first":"Jane","last":"Murphy","age":47}] name:{"first":"Tom","last":"Anderson"}]
    //gjson.Result, Deer Hunter
    //gjson.Result, [{"first":"Dale","last":"Murphy","age":44},{"first":"Roger","last":"Craig","age":68},{"first":"Jane","last":"Murphy","age":47}]
    //gjson.Result, {"first":"Tom","last":"Anderson"}
    //gjson.Result, 37
    //gjson.Result, ["Sara","Alex","Jack"]
}
